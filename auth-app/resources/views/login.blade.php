        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <form method="POST" action="/auth-login" class="shadow-lg rounded-lg py-4 px-5">
                ...
                <div class="mt-4">
                    ...
                    <input class="w-full shadow-inner bg-gray-100 rounded-lg placeholder-black text-base p-3 border-none block mt-1 w-full" id="email" type="email" name="email" required="required" placeholder="email"
                        value="{{ old('email') }}">
                    @if ($errors->has('email'))
                ...
                <div class="mt-4">
                    ...
                    <input class="w-full shadow-inner bg-gray-100 rounded-lg placeholder-black text-base p-3  border-none block mt-1 w-full" id="password" type="password" name="password" required="required" autocomplete="new-password" placeholder="*********" value="{{ old('password') }}">
                ...
                <div class="flex items-center justify-between mt-8">
                    <button type="submit" class="flex items-center justify-center px-3 py-2 border border-transparent text-base font-medium rounded-md text-white bg-blue-700 hover:bg-indigo-700 md:py-3 md:text-base md:px-4">Login</button>
                    <a class="font-semibold" href="{{ route('register') }}">
                        no account? <span class="text-blue-700">signup</span>
                    </a>
                </div>
            </form>
